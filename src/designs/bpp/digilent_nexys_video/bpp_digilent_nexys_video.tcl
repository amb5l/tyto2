################################################################################
## bpp_digilent_nexys_video.tcl                                               ##
## Digilent Nexys Video board specific constraints for the BPP design.        ##
################################################################################
...
create_generated_clock -name sys_clk_96m [get_pins MMCM_SYS/MMCM/CLKOUT0]
create_generated_clock -name sys_clk_48m [get_pins MMCM_SYS/MMCM/CLKOUT1]
create_generated_clock -name sys_clk_32m [get_pins MMCM_SYS/MMCM/CLKOUT2]
create_generated_clock -name sys_clk_8m  [get_pins MMCM_SYS/MMCM/CLKOUT3]
create_generated_clock -name hdtv_clk    [get_pins MMCM_HDTV/MMCM/CLKOUT1]
create_generated_clock -name pcm_clk     [get_pins MMCM_PCM/MMCM/CLKOUT0]
...
set pins_ram_cache_rd                            [get_pins -include_replicated_objects {MAIN/CORE/RAM/LATCH_A/if_d[*]}]
set pins_ram_cache_rd [concat $pins_ram_cache_rd [get_pins -include_replicated_objects {MAIN/CORE/RAM/LATCH_B/ls_dr[*]}]]
set pins_ram_cache_rd [concat $pins_ram_cache_rd [get_pins -include_replicated_objects {MAIN/CORE/CACHE_*/cache_dr[*]_INST_0/O}]]
...
set c2m_sc                 [get_pins -include_replicated_objects {MAIN/CORE/rst_s_reg[1]/Q}]
set c2m_sc [concat $c2m_sc [get_pins -include_replicated_objects {MAIN/CORE/rst_reg/Q}]]
set c2m_sc [concat $c2m_sc [get_pins -include_replicated_objects {MAIN/CORE/clk_phdet_reg[0]/Q}]]

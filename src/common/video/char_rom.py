...
with open(out_filename,'w') as f:
    ...
    f.write('\n')
    f.write('package char_rom_437_8x16_pkg is\n')
    f.write('\n')
    f.write('    component char_rom_437_8x16 is\n')
    f.write('        port (\n')
    ...
    f.write('        );\n')
    f.write('    end component char_rom_437_8x16;\n')
    f.write('\n')
    f.write('end package char_rom_437_8x16_pkg;\n')
    f.write('\n')
    f.write('library ieee;\n')
    f.write('use ieee.std_logic_1164.all;\n')
    f.write('\n')
    ...
    f.write('\n')
    f.write('architecture behavioural of '+filename_root+' is\n')
    f.write('begin\n')
    f.write('\n')
    f.write('    process(clk)\n')
    f.write('    begin\n')
    ...
    f.write('    end process;\n')
    f.write('\n')
    f.write('end architecture behavioural;\n')
